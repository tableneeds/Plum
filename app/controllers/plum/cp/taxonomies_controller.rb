  ...
  module Cp
    class TaxonomiesController < BaseController
      ...
      def create
        ...
        if @taxonomy.save
          redirect_to cp_taxonomy_path(@taxonomy), notice: "Taxonomy created"
        else
      ...
      def update
        if @taxonomy.update(taxonomy_params)
          redirect_to cp_taxonomy_path(@taxonomy), notice: "Taxonomy updated"
        else
      ...
      def destroy
        @taxonomy.destroy
        redirect_to cp_taxonomies_path, notice: "Taxonomy deleted"
      end
